...
async function getServerEntry() {
  if (!serverEntryPromise) serverEntryPromise = import('../_/server-rRat-b_i.mjs').then(function (n) { return n.s; }).then((m) => m.default ?? m);
...
export { entry$1 as e, renderErrorPage as r };
