...
import { resolveManifestAssetLink, resolveManifestCssLink, createSerializationAdapter, rootRouteId, createRawStreamRPCPlugin, invariant, isNotFound, isRedirect, isResolvedRedirect, executeRewriteInput, defaultSerovalPlugins, makeSerovalPlugin, getScriptPreloadAttrs, getStylesheetHref } from '@tanstack/router-core';
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import('./_tanstack-start-manifest_v-CoWrgnMU.mjs');
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import('./router-CtBFpLhp.mjs'),
    import('./start-CxjCXmAx.mjs'),
...
const serverRRatB_i = /*#__PURE__*/Object.freeze({
	__proto__: null,
	createServerEntry: createServerEntry,
	default: server_default
});

export { createCsrfMiddleware as a, createMiddleware as c, serverRRatB_i as s };
//# sourceMappingURL=server-rRat-b_i.mjs.map
